...
*Note*: All static test setup methods are executed before any data provider such that all static
fields can be prepared in ```@BeforeClass``` setup methods and smoothly accessed within
