...
val junitJupiterVersion by extra(findProperty("junitJupiterVersion")?.toString() ?: "5.14.1")
val junitJupiterPlatformVersion by extra(findProperty("junitJupiterPlatformVersion")?.toString() ?: "1.14.1")
