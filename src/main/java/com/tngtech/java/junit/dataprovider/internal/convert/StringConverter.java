...
public class StringConverter {
	...
	/**
	 * Converts the given {@code data} to its corresponding arguments using the given {@code parameterTypes} and other provided information.
	 *
	 * @param data
	 *            regex-separated {@link String} of parameters for test method
	 * @param isVarArgs
	 *            determines whether test method has a varargs parameter
	 * @param parameterTypes
	 *            target types of parameters to which corresponding values in regex-separated {@code data} should be converted
	 * @param dataProvider
	 *            containing settings which should be used to convert given {@code data}
	 * @param rowIdx
	 *            index of current {@code data} (row) for better error messages
	 * @return split, trimmed and converted {@code Object[]} of supplied regex-separated {@code data}
	 * @throws IllegalArgumentException
	 *             iif count of split data and parameter types does not match or argument cannot be converted to required type
	 */
	...
	private Object convertValue(String str, Class<?> targetType) {
		...
		Object result = convertUsingCustomTypes(str, targetType);

		if (result != null) {
			return result;
		}
		result = tryConvertUsingSingleStringParamConstructor(str, targetType);
		if (result != null) {
			return result;
		}
	...
	protected Object convertUsingCustomTypes(String str, Class<?> targetType) {
		return null;
	}
