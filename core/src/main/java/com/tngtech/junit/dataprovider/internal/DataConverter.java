...
public class DataConverter {
    ...
    /**
     * Returns {@code true} if and only if this {@link DataConverter} can convert the given {@code type}. Currently
     * supported {@code type}s:
     * <ul>
     * <li>Object[][]</li>
     ...
     * </ul>
     *
     * Please note, that {@link Iterable} can be replaced by any valid subtype (checked via
     * {@link Class#isAssignableFrom(Class)}). As well as an arbitrary inner type is also accepted. Only rawtypes are
     ...
     * @return {@code true} if and only if given {@code type} can be converted.
     */
     ...
     * @throws NullPointerException if and only if given {@code parameterTypes} or {@code dataProvider} are {@code null}
